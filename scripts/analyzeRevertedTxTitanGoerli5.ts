...
async function main() {
  ...
  mintArgs = {
    ...
    amount0Min: ethers.BigNumber.from('2832429745193023361'),
    amount1Min: ethers.BigNumber.from('5865466800498285040'),
    recipient: '0xB68AA9E398c054da7EBAaA446292f611CA0CD52B',
    deadline: ethers.BigNumber.from('11963744845'),
  }
  tx = await nftContract.mint(mintArgs)
  await tx.wait()
  ...
  console.log(balance)
  //let tokenId = await nftContract.tokenOfOwnerByIndex(deployer.address, balance - 1)
  let tokenId = 1
